...
const char MSG_DELIMINTER[]=":";
const char MSG_DELIMINTERSITE[]="-";
...
const char MSG_DELIMINTERARMEE[]=",";
...
int messageToHutte(char * msg, hutte * mahutte){
    ...
    for(i=0;splitmessage[i]!=NULL;i=i+2) {

        mahutte->stock[(matieres_premieres)atoi(splitmessage[i])]= atoi(splitmessage[i+1]);
